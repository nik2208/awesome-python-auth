...
- Never commit `access_token_secret`, `refresh_token_secret`, or other secrets to source control.
- Rotate JWT secrets if you suspect they have been exposed.
- Keep the library updated to receive security patches (`pip install --upgrade awesome-python-auth`).
